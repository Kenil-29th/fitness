...
const RegisterScreen = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            // Optionally, you might want to log the user in immediately after registration
            // localStorage.setItem('userInfo', JSON.stringify(data));
            navigate('/login'); // Redirect to login screen after successful registration
        } catch (err) {
            setError(err.response && err.response.data.msg ? err.response.data.msg : 'Registration failed');
        }
    };
